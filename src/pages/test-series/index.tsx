...
{  props.pageData?.widgetJson['RESULTS'] &&  <div className={'container my-6 xl:my-10'}>
                <ResultsSection results={props.pageData?.widgetJson['RESULTS']?.sectionProps} title={'Academic Excellence : Results'}
    ...
    {
        props.pageData?.faqs && <div className={'container my-6 xl:my-10'}>
          <FAQ items={props.pageData?.faqs} />
        </div>
      }
      {  props.pageData?.widgetJson['APP_DOWNLOAD'] &&  <div className={'container pt-6 xl:pt-10 xl:mb-20 mb-10'}>
              
                       <DownloadAppBanner config={props.pageData?.widgetJson['APP_DOWNLOAD']} />
            </div>
    }
