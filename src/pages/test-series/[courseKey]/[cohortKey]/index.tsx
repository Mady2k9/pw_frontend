...
export default function CourseCohortTestSeries(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
  ...
  return <Layout noIndex={true}  footerData={props.footerData} seoSchema={props.pageData.seoSchema} seoTags={props.pageData.seoTags} headerData={props.headerData} page_source={'TEST_SERIES_COHORT_LISTING'}>
