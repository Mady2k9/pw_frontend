...
import AboutBgImage from '../../../../assets/Images/gpw.webp';
        ...
        >
          ...
          >
            <div
              ...
              style={{
                backgroundImage: `url(${AboutBgImage.src})`,
              }}
            >
              ...
              <h1 className="font-[500] text-[24px] leading-[32px] md:text-[60px] md:leading-[80px] text-white my-1 md:my-1 ">
              ...
              >
                <div className="flex justify-center">
                  <Image
                    ...
                    className={`h-[32px] w-[32px] md:h-[45px] md:w-[45px] bg-center bg-no-repeat bg-contain animate-bounce scale-y-50`}
                  />
                </div>
