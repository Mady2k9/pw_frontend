...
import knowMore from '../../../../assets/Images/knowMoreArrow.webp';
...
export default function Drawer({ isOpen, setIsOpen }: DrawerProps) {
  ...
  return (
    ...
    //                 className={`h-[34px] w-[34px] md:h-[40px] md:w-[40px] bg-center bg-no-repeat bg-contain animate-bounce`}
    //               />
    //             </div>
    ...
    <Transition.Child
           as={Fragment}
                   ...
                   leaveTo="-translate-y-full"
          >
    <div className="bg-red-400 absolute z-[10] w-screen h-screen top-0"
      ref={scrollableRef}
