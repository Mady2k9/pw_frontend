...
const MissionSection = () => {
  return (
    <>
      <div
        className="mx-auto md:pt-[20px] md:pb-[40px] pt-[18px] xl:bg-bottom 2xl:bg-cover bg-cover xl:bg-contain bg-no-repeat sm:block hidden"
        style={{
      ...
      >
        ...
        <div className="max-w-6xl md:flex md:flex-col lg:flex lg:flex-row justify-around items-center md:pb-[32px] py-[18px] px-[16px] mx-auto">
      ...
      <div
        className="mx-auto md:pt-[18px] md:pb-[40px] pt-[18px] bg-bottom bg-cover bg-no-repeat block sm:hidden"
        style={{
          ...
          <div className="md:columns-4 columns-12 md:w-[356px] sm:w-full h-[120px] my-[20px] rounded-lg relative">
            ...
            <div className="w-[97%] h-auto rounded-lg bg-[#E7F6FA] absolute bottom-1 right-1 top-1 left-1 align-middle">
              <div className="pt-[30px] pb-[30px] px-[16px] flex gap-x-4 ">
                ...
                <div className="text-[16px] pt-3 md:text-[18px] md:px-0 md:text-center items-center xl:text-start text-[#1B2124] font-[600] leading-7">
                  To build a
                  <span className="text-[#5A4BDA] me-2">business</span>
                  sustainability
                </div>
              </div>
            </div>
