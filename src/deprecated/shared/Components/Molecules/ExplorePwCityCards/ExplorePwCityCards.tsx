...
const ExplorePwCityCards = ({
  ...
  return (
    ...
    >
      ...
      <Image
        bgImagetitle={exploreCityCardData?.cityIcon}
        className={
          'md:w-14 md:h-14 w-10 h-10 bg-center group-hover:scale-[155%] ease-in-out duration-500 bg-no-repeat bg-cover rounded-[4px] mr-4'
        }
      />
