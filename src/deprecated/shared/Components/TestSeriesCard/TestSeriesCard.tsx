...
const TestSeriesCard = ({
  ...
  return (
    <>
      <div className="border border-white rounded-lg  mb-3.5">
        <div className="p-[1px] bg-gradient-to-b from-blue-500 to-white border-white rounded-lg">
          <div
            className={` border xl:min-w-[366px] relative max-w-[350px] min-w-[320px] p-3.5 md:p-4 rounded-lg bg-white shadow-md`}
            key={key}
          >
            {showOnlineOfflineTag && (
              <Image
